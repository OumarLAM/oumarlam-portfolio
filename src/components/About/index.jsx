    ...
    <div className="container about-page">
      <div className="text-zone">
        ...
        <p>
          ...
          constantly strive to expand my knowledge and stay up-to-date with the
          latest industry trends.
        </p>
        <p>
          {" "}
          I am a quick learner, adaptable, and enjoy working in a collaborative
          team environment. I am eager to contribute my skills and expertise to
